...
const DUA_LIST = [
  ...
  { id: "waking", emoji: "🌅", en: { title: "Upon Waking" }, bn: { title: "ঘুম থেকে জাগার পর" },
    ...
    translit: "Al-\u1e25amdu lill\u0101hil-ladh\u012b a\u1e25y\u0101n\u0101 ba\u2018da m\u0101 am\u0101tan\u0101 wa ilayhin-nush\u016br.",
  ...
  { id: "enterToilet", emoji: "🚪", en: { title: "Entering the Toilet" }, bn: { title: "টয়লেটে প্রবেশ করার সময়" },
    ...
    translit: "All\u0101humma inn\u012b a\u2018\u016bdhu bika minal-khubthi wal-khab\u0101'ith.",
  ...
  { id: "afterEating", emoji: "🍽", en: { title: "After Eating" }, bn: { title: "খাওয়ার পরে" },
    ...
    translit: "Al-\u1e25amdu lill\u0101hil-ladh\u012b a\u1e6d\u2018aman\u012b h\u0101dh\u0101 wa razaqan\u012bhi min ghayri \u1e25awlin minn\u012b wa l\u0101 quwwah.",
  ...
  { id: "rizq", emoji: "💰", en: { title: "Seeking Rizq" }, bn: { title: "রিযিক প্রার্থনায়" },
    ...
    translit: "All\u0101humma-kfin\u012b bi-\u1e25al\u0101lika \u2018an \u1e25ar\u0101mika wa aghnin\u012b bi-fa\u1e0dlika \u2018amman siw\u0101k.",
  ...
  { id: "hardship", emoji: "😞", en: { title: "During Hardship" }, bn: { title: "কষ্টের সময়" },
    ...
    translit: "L\u0101 il\u0101ha illall\u0101hul-\u2018A\u1e93\u012bmul-\u1e24al\u012bm\u2026",
  ...
  { id: "forgiveness", emoji: "🤲", en: { title: "Seeking Forgiveness" }, bn: { title: "ক্ষমা প্রার্থনায়" },
    ...
    translit: "Rabbighfir l\u012b wa tub \u2018alayya, innaka Antat-Taww\u0101bur-Ra\u1e25\u012bm.",
  ...
  { id: "bestDua", emoji: "❤️", en: { title: "The Best General Du\u02BF\u0101\u02BE" }, bn: { title: "সর্বোত্তম দোয়া" },
    ...
    translit: "Rabban\u0101 \u0101tin\u0101 fid-duny\u0101 \u1e25asanatan wa fil-\u0101khirati \u1e25asanatan wa qin\u0101 \u2018adh\u0101ban-n\u0101r.",
  ...
  { id: "bestInLife", emoji: "🌟", en: { title: "Asking for the Best in This Life and the Next" }, bn: { title: "দুনিয়া ও আখিরাতের কল্যাণ কামনায়" },
    ...
    translit: "All\u0101humma inn\u012b as'alukal-hud\u0101 wat-tuq\u0101 wal-\u2018af\u0101fa wal-ghin\u0101.",
...
const UI_STRINGS = {
  en: {
    ...
    haveAccount: "Already have an account? Recover it here",
    signIn: "Sign In",
    ...
    home: "Home", recitation: "Qur\u2019an Plan", dhikr: "Dhikr Tools", dua: "Du\u2019a", dashboard: "Dashboard",
    scheduleTitle: "Daily Qur\u2019an Recitation Sunnah Schedule",
    ...
    times: "times", pronunciation: "Pronunciation", readSurah: "Read the Surah",
    ayatulKursiTitle: "\u0100yat al-Kurs\u012b \u2014 S\u016brah Al-Baqarah 2:255",
    lastTwoVersesTitle: "S\u016brah Al-Baqarah 2:285\u2013286",
    dashboardIntro: "Today's dhikr at a glance."
  },
  bn: {
    appTitle: "মগ্নচৈতন্য ভৃত্য",
    ...
    haveAccount: "আগে থেকে অ্যাকাউন্ট আছে? এখানে রিকভার করুন",
    signIn: "সাইন ইন",
    ...
    unlock: "আনলক করুন",
    usernamePrompt: "ইউজারনেম",
    home: "হোম", recitation: "কুরআন পরিকল্পনা", dhikr: "যিকির টুলস", dua: "দোয়া", dashboard: "ড্যাশবোর্ড",
    scheduleTitle: "দৈনন্দিন সুন্নাহভিত্তিক কুরআন তিলাওয়াতের আমল",
    ...
    times: "বার", pronunciation: "উচ্চারণ", readSurah: "সূরাটি পড়ুন",
    ayatulKursiTitle: "আয়াতুল কুরসী \u2014 সূরা আল-বাকারা ২:২৫৫",
    lastTwoVersesTitle: "সূরা আল-বাকারা ২:২৮৫\u2013২৮৬",
    dashboardIntro: "আজকের যিকিরের সংক্ষিপ্ত চিত্র।"
  }
};

/* ---------------------------------------------------------------
 * Reference-string translator: a handful of Arabic-transliterated
 * bibliographic terms recur across many hadith references. Rather
 * than hand-writing a Bengali twin for every single reference, we
 * translate the recurring terms in English refs on the fly when
 * the UI language is Bengali. Items that already ship a full native
 * Bengali `ref` (recitation items, dhikr library) are unaffected —
 * this is only used where a Bengali ref string doesn't already exist
 * (currently: the Du'a screen).
 * ------------------------------------------------------------- */
const REF_TRANSLATE_PAIRS = [
  [/\u1e62a\u1e25\u012b\u1e25 al-Bukh\u0101r\u012b/g, "সহীহ্‌ আল-বুখারী"],
  [/\u1e62a\u1e25\u012b\u1e25 Muslim/g, "সহীহ্‌ মুসলিম"],
  [/Sunan at-Tirmidh\u012b/g, "সুনান আত-তিরমিযী"],
  [/Sunan al-Tirmidh\u012b/g, "সুনান আত-তিরমিযী"],
  [/Sunan Ab\u016b D\u0101w\u016bd/g, "সুনান আবু দাউদ"],
  [/J\u0101mi\u02BF al-Tirmidh\u012b/g, "জামিউ আত-তিরমিযী"],
  [/Al-Mustadrak of al-\u1e24\u0101kim/g, "আল-মুস্তাদরাক, ইমাম হাকিম"],
  [/\u1e24asan/g, "হাসান"],
  [/\u1e62a\u1e25\u012b\u1e25/g, "সহীহ্‌"],
  [/Qur'an/g, "কুরআন"]
];
function translateRef(ref) {
  if (!ref) return ref;
  let out = ref;
  REF_TRANSLATE_PAIRS.forEach(([pattern, replacement]) => { out = out.replace(pattern, replacement); });
  return out;
}

/* ---------------------------------------------------------------
 * EMBEDDED VERSES — full Arabic text (with an original, non-verbatim
 * plain-language rendering in EN/BN) for the two recitation items
 * that call for the verse itself rather than just a hadith blurb.
 * ------------------------------------------------------------- */
const EMBEDDED_VERSES = {
  ayatulKursi: {
    ...
    en: "Allah \u2014 there is no god but Him, the Ever-Living, the Sustainer of all existence. Neither drowsiness nor sleep overtakes Him. Everything in the heavens and on the earth belongs to Him. Who can intercede with Him except by His permission? He knows what is before His creation and what is behind them, while they grasp nothing of His knowledge except what He wills. His throne extends over the heavens and the earth, and safeguarding both does not tire Him. He is the Most High, the Most Great.",
    bn: "আল্লাহ ছাড়া প্রকৃত কোনো উপাস্য নেই; তিনি চিরঞ্জীব, সমগ্র সৃষ্টির ধারক ও নিয়ন্ত্রক। তন্দ্রা বা নিদ্রা তাঁকে স্পর্শ করতে পারে না। আকাশমণ্ডলী ও পৃথিবীতে যা কিছু আছে, সবই তাঁর। তাঁর অনুমতি ছাড়া তাঁর কাছে কে সুপারিশ করতে পারে? সৃষ্টির সামনে ও পেছনে যা কিছু আছে, তিনি সব জানেন; অথচ তারা তাঁর জ্ঞানের কিছুই আয়ত্ত করতে পারে না, তিনি যতটুকু ইচ্ছা করেন তা ছাড়া। তাঁর কুরসি আকাশ ও পৃথিবীকে পরিবেষ্টন করে আছে, আর এ দুটির রক্ষণাবেক্ষণ তাঁকে ক্লান্ত করে না। তিনিই সর্বোচ্চ, সর্বমহান।"
  },
  lastTwoBaqarah: {
    ...
    en: "The Messenger believes in what has been revealed to him from his Lord, and so do the believers \u2014 each one believes in Allah, His angels, His books, and His messengers, saying: \u2018We make no distinction between any of His messengers.\u2019 And they say: \u2018We hear and we obey; grant us Your forgiveness, our Lord, for to You is our return.\u2019 Allah does not burden any soul beyond what it can bear; each soul is rewarded for the good it earns and answerable for the wrong it does. \u2018Our Lord, do not hold us accountable if we forget or make a mistake. Our Lord, do not place on us a burden like the one You placed on those before us. Our Lord, do not burden us with more than we have strength to bear. Pardon us, forgive us, and have mercy on us \u2014 You are our Protector, so grant us victory over the disbelieving people.\u2019",
    bn: "রাসূল তাঁর রবের পক্ষ থেকে যা তাঁর প্রতি নাযিল করা হয়েছে, তাতে বিশ্বাস স্থাপন করেছেন, আর মুমিনরাও তা বিশ্বাস করে — প্রত্যেকে আল্লাহ, তাঁর ফেরেশতাগণ, তাঁর কিতাবসমূহ ও তাঁর রাসূলগণের প্রতি ঈমান এনেছে; তারা বলে, 'আমরা তাঁর রাসূলগণের মধ্যে কোনো পার্থক্য করি না।' আর তারা বলে, 'আমরা শুনেছি ও মেনে নিয়েছি; হে আমাদের রব, আপনার ক্ষমা প্রার্থনা করছি, আর আপনার দিকেই প্রত্যাবর্তন।' আল্লাহ কাউকে তার সাধ্যের বাইরে দায়িত্ব দেন না; প্রত্যেকে তার অর্জিত ভালোর প্রতিদান পাবে এবং তার কৃত মন্দের জবাবদিহি করবে। 'হে আমাদের রব, আমরা ভুলে গেলে বা ভুল করলে আমাদের পাকড়াও করবেন না। হে আমাদের রব, আমাদের ওপর এমন কোনো ভার চাপাবেন না, যেমনটি আমাদের পূর্ববর্তীদের ওপর চাপিয়েছিলেন। হে আমাদের রব, যা বহন করার সাধ্য আমাদের নেই তা আমাদের ওপর চাপাবেন না। আমাদের মাফ করুন, ক্ষমা করুন এবং দয়া করুন — আপনিই আমাদের অভিভাবক, সুতরাং কাফের সম্প্রদায়ের বিরুদ্ধে আমাদের সাহায্য করুন।'"
  }
};

/* ---------------------------------------------------------------
 * "Read the Surah" capsule links (quran.com) for recitation items
 * that don't get their full text embedded above.
 * ------------------------------------------------------------- */
const SURAH_LINKS = {
  morningEvening: [
    { label: "Al-Ikhl\u0101\u1e63 (112)", url: "https://quran.com/112" },
    { label: "Al-Falaq (113)", url: "https://quran.com/113" },
    { label: "Al-N\u0101s (114)", url: "https://quran.com/114" }
  ],
  kafirun: [{ label: "Al-K\u0101fir\u016bn (109)", url: "https://quran.com/109" }],
  ikhlasFalaqNas: [
    { label: "Al-Ikhl\u0101\u1e63 (112)", url: "https://quran.com/112" },
    { label: "Al-Falaq (113)", url: "https://quran.com/113" },
    { label: "Al-N\u0101s (114)", url: "https://quran.com/114" }
  ],
  everyNight: [{ label: "Al-Mulk (67)", url: "https://quran.com/67" }],
  everyFriday: [{ label: "Al-Kahf (18)", url: "https://quran.com/18" }],
  fridayFajr: [
    { label: "As-Sajdah (32)", url: "https://quran.com/32" },
    { label: "Al-Ins\u0101n (76)", url: "https://quran.com/76" }
  ]
};
